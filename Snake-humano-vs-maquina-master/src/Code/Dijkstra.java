...
public class Dijkstra {
     ...
     * camino mas corto.
     * @param dist int[][] vector números enteros
     * @param verticeYaProcesado boolean[][] vector
     * @return distancia mínima del bot hasta la manzana
     */
    ...
    /**
     * Función que devuelve un vector con la distancia desde
     * la manzana hasta la serpiente
     * @param grafo int[][] vector enteros
     * @param nodoDestino número entero
     * @return la distancia mas corta desde el nodo inicial hasta el vertice
     */
